...
// ToDo: define and document dependencies between flags/attributes
    ...
    BinaryDataArray(            "binaryDataArray",              false,      null /*multiple locations*/,                                                                    false,      BinaryDataArray.class,              true,          BinaryDataArrayRefResolver.class),
    ...
    Run(                        "run",                          true,       "/mzML/run",                                                                                    true,       Run.class,                          true,          RunRefResolver.class),
    ...
    SourceFileRef(              "sourceFileRef",                false,      null /*multiple locations*/,                                                                    false,      SourceFileRef.class,                true,          SourceFileRefResolver.class),
    Spectrum(                   "spectrum",                     true,       "/mzML/run/spectrumList/spectrum",                                                              true,       Spectrum.class,                     true,          SpectrumRefResolver.class),
    SpectrumList(               "spectrumList",                 true,       "/mzML/run/spectrumList",                                                                       false,      SpectrumList.class,                 true,          SpectrumListRefResolver.class),
