...
public class ObjectFactory {
    ...
    private final static QName _ComponentListDetector_QNAME = new QName("http://psi.hupo.org/ms/mzml", "detector");
    private final static QName _ComponentListAnalyzer_QNAME = new QName("http://psi.hupo.org/ms/mzml", "analyzer");
    private final static QName _ComponentListSource_QNAME = new QName("http://psi.hupo.org/ms/mzml", "source");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://psi.hupo.org/ms/mzml", name = "detector", scope = ComponentList.class)
    public JAXBElement<Component> createComponentListDetector(Component value) {
        return new JAXBElement<Component>(_ComponentListDetector_QNAME, Component.class, ComponentList.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://psi.hupo.org/ms/mzml", name = "analyzer", scope = ComponentList.class)
    public JAXBElement<Component> createComponentListAnalyzer(Component value) {
        return new JAXBElement<Component>(_ComponentListAnalyzer_QNAME, Component.class, ComponentList.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://psi.hupo.org/ms/mzml", name = "source", scope = ComponentList.class)
    public JAXBElement<Component> createComponentListSource(Component value) {
        return new JAXBElement<Component>(_ComponentListSource_QNAME, Component.class, ComponentList.class, value);
    }
