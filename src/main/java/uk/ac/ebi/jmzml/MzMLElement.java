...
// ToDo: define and document dependencies between flags/attributes
    ...
    ReferenceableParamGroupRef( "referenceableParamGroupRef",   false,      null /*multiple locations*/,                                                                    false,      ReferenceableParamGroupRef.class,   false,          ReferenceableParamGroupRefResolver.class),
    ...
    SpectrumList(               "spectrumList",                 true,       "/mzML/run/spectrumList",                                                                       false,      SpectrumList.class,                 false,          SpectrumRefResolver.class),
